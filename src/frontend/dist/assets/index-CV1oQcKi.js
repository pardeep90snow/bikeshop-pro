...
import { h as Subscribable, s as shallowEqualObjects, i as hashKey, k as getDefaultState, n as notifyManager, l as useQueryClient, r as reactExports, m as noop, o as shouldThrowError, j as jsxRuntimeExports, p as composeRefs, q as o, u as useComposedRefs, d as reactDomExports, R as React, v as vt } from "./index-GpFbm5So.js";
import { b as useActor, c as useQuery, d as createActor } from "./useServices-CMQRbiaK.js";
...
function useBookings() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        const result = await actor.listBookings();
        return result;
      } catch {
...
function useAvailableSlots(date, serviceId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        const result = await actor.getAvailableSlots(date, serviceId);
        return result;
      } catch {
        return [];
      }
...
export {
  ...
  createSlot as i,
  useCreateBooking as j,
  useAvailableSlots as k,
  ue as l,
  useBookings as m,
  useUpdateBookingStatus as n,
  useCallbackRef as u
};
